...
@endif
 ...
 <div class="container whiteback  no-margin m-t-2">

   <div class="row">
      
    <div class="col-12 h4-tit b-bottom-1 no-padding">
        <h4 class="form-title"> New Employee</h4>
    </div>
     
 
        <form method="post" novalidate  id="new_employee" action="{{ route('employees.store') }}" class="pt-20 pb-20" enctype="multipart/form-data">
         ...
         <div class="row">
            ...
            <div class="col-3">
                <label class="pure-material-textfield-outlined">
                    <input type="text" name="job_title" class="form-control" placeholder=" " dir="auto">
                    <span>Job Title</span>
                </label> 
            </div>
            ...
            <div class="col-3">
                <label class="pure-material-textfield-outlined">
                    <input type="date" name="hiring_date"  class="form-control" placeholder=" " dir="auto">
